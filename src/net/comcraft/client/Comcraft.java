...
//        render.reloadRender();
        ...
        printUsedMemory("startGame():");
        
        
        //showScreenVisit();
    }
    public void printUsedMemory(String label)
    {
        if(label != null)
...
//#                 ex.printStackTrace();
                ...
                //#debug debug
//#                 System.err.println(ex.getClass()+" " + ex.getOriginalMessage());
                displayGuiScreen(new GuiError(ex));
            } catch (OutOfMemoryError error) {
                //#debug debug
//#                 error.printStackTrace();
...
//        render.reloadRender();
        ...
        printUsedMemory("playerManager.createPlayer():");
        world = new World(this, saveHandler, worldInfo);
        printUsedMemory("new World(this, saveHandler, worldInfo):");
